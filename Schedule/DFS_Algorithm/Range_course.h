...
template<int terms_num,int max_size> 
bool Range_Course<terms_num,max_size>::range(int num,int term,const char course_name[])
{    //排课
...
template<int terms_num,int max_size> 
bool Range_Course<terms_num,max_size>::range_one(int &week_day,int term, const char course_name[])
{    //排一天的1节课
    int i,k;
    for(k=0;k<5;k++){
...
template<int terms_num,int max_size> 
bool Range_Course<terms_num,max_size>::range_two(int &week_day,int term, const char course_name[])
{    //排一天的2节课
...
template<int terms_num,int max_size> 
bool Range_Course<terms_num,max_size>::range_three(int &week_day,int term, const char course_name[])
{    //排一天的3节课
    int i,k,week_day_tem;
    for(k=0;k<5;k++){
...
template<int terms_num,int max_size> 
void Range_Course<terms_num,max_size>::write(const char s[],int l)
{    //输出指定长度的字符串 
    int i;
    (*outfile)<<s;
